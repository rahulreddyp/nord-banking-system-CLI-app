...
class RewardPointsTest {
  ...
  public void setUp() {
    ...
    persistence = new RewardPointsMockPersistence(BALANCE_FOR_TEST_USER, mock.getRewards());
  ...
  public void getRewardsTest() {
    ...
    System.setIn(in);
    IRewardPoints rewardPoints = new RewardPoints().setRewardPointsDb(persistence).setRewardPointsView(new RewardPointView());
