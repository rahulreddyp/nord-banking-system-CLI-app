...
public class FeedbackTest {
  ...
  void enterFeedbackTest() {
    ...
    IEnterFeedback enterFeedback = new EnterFeedback().setFactory(feedbackFactory).setView(feedbackCustomerSideView);
  ...
  void feedbackServiceCustomerSideTest() {
    ...
    IFeedbackFactory feedbackFactory = new FeedbackFactory();
    IFeedbackCustomerSideView feedbackCustomerSideView = new FeedbackCustomerSideView();
    IFeedbackServiceCustomerSide feedbackServiceCustomerSide = new FeedbackServiceCustomerSide().setFeedbackFactory(feedbackFactory).setView(feedbackCustomerSideView);
  ...
  void feedbackServiceAdminSideTest() {
    ...
    IFeedbackServiceAdminSide feedbackServiceAdminSide = new FeedbackServiceAdminSide().setFactory(feedbackFactory).setView(feedbackServiceAdminSideView);
