...
class CreditScoreLoanHistoryTest {
  ...
  void showLoanHistory() {
    ...
    factory.creditScoreLoanHistory().setFactory(factory).setView(creditScoreLoanView).showLoanHistory(factory.getCreditScoreLoanHistoryModel().getCreditScoreLoanHistory());
