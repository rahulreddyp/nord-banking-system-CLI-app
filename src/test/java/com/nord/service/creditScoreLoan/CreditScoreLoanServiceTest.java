...
class CreditScoreLoanServiceTest {
  ...
  void creditScoreLoanHomePage() {
    ...
    ICreditScoreLoanService creditScoreLoanService = new CreditScoreLoanService().setFactory(factory).setView(creditScoreLoanViewview);
  ...
  void updateCreditLoanService() {
    ICreditScoreLoanFactory factory = new CreditScoreLoanFactory();
    ICreditScoreLoanService creditScoreLoanService = new CreditScoreLoanService().setFactory(factory);
  ...
  void showCreditScoreLoanService() {
    ...
    ICreditScoreLoanFactory factory = new CreditScoreLoanFactory();
    ICreditScoreLoanView creditScoreLoanViewview = new CreditScoreLoanView();
    ICreditScoreLoanService creditScoreLoanService = new CreditScoreLoanService(factory).setFactory(factory).setView(creditScoreLoanViewview);
