...
class PayCreditLoanTest {
  ...
  void payCreditLoanByGivenLoans() {
    ...
    factory.payForCreditLoan().setFactory(factory).setView(creditScoreLoanView).payCreditLoanByGivenLoans(factory.getCreditScoreLoanHistoryModel().getCreditScoreLoanHistory());
  ...
  void getPayLoanCount() {
    ...
    ICreditScoreLoanFactory factory = new CreditScoreLoanFactory();
    ICreditScoreLoanView creditScoreLoanView = new CreditScoreLoanView();
    int actualOutput = factory.payForCreditLoan().setFactory(factory).setView(creditScoreLoanView).getPayLoanCount(list);
  ...
  void payCreditLoanByDateTest() {
    ...
    Date date = new Date();
    ICreditScoreLoanView creditScoreLoanView = new CreditScoreLoanView();
    boolean expectedOutPut = factory.payForCreditLoan().setView(creditScoreLoanView).setFactory(factory).payCreditLoanByDate(amount, date);
