...
class CreditCardRecommendationServiceTest {
  ...
  private CreditCardRecommendationHomePageMock creditCardRecommendationHomePageMock = new CreditCardRecommendationHomePageMock();
  ...
  void creditCardRecommendationHomepage() {
    ...
    ICreditCardRecommendationService creditCardRecommendationService = new CreditCardRecommendationService().setFactory(creditCardFactory).setView(creditServiceView).setTypeView(typesView);
