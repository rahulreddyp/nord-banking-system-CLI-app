...
/**
 * Test getting fixed deposit by plan
 *
 * @author Abdul Mueed Qadri
 */
public class GetFixedDepositByPlanTest {
  ...
  private String MOCK_TEST_TERM = "short";
  ...
  @Test
  void getFdByPlanTest() {
    String input = "1 1000 12/08/2021";
    InputStream in = new ByteArrayInputStream(input.getBytes());
    System.setIn(in);
    IGetFixedDeposit fixedDeposits = new GetFixedDepositByPlan().setView(new FixedDepositPlanView()).setSelectedFd(new UserFixedDepositModel()).setSelectedTerm(MOCK_TEST_TERM);
    IUserFixedDepositModel selectedFd = fixedDeposits.getFixedDeposit(plans.getFds());
