...
public class FixedDepositTest {
  ...
  void fdMenuTest() {
    ...
    IFixedDepositPlanPersistence planPersistence = new FixedDepositPlanPersistence();
    ...
    IFixedDeposit fixed = new FixedDeposit().setFactory(fdFactory).setView(fdView).setPersistence(planPersistence);
