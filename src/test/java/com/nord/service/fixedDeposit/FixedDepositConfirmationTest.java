...
public class FixedDepositConfirmationTest {
  ...
  void fdAdditionTest() {
    ...
    IFixedDepositConfirmation confirmation = new FixedDepositConfirmation().setView(new FixedDepositConfirmationView()).setUserPersistence(userFd).setFixedDepositPlans(plans.getFds()).setSelectedFd(mock.getMockFd()).setUpgradeableFd(new UserFixedDepositModel());
  ...
  void fdUpgradeTest() {
    ...
    IFixedDepositConfirmation confirmation = new FixedDepositConfirmation().setView(new FixedDepositConfirmationView()).setUserPersistence(userFd).setFixedDepositPlans(plans.getFds()).setSelectedFd(mock.getMockFdWithSuggestion()).setUpgradeableFd(new UserFixedDepositModel());
    confirmation.fdConfirmation();
