...
public class CreditCardTypesView implements ICreditCardTypesView {
  ...
  public void setCreditCardDetail() {
    ...
    creditCardDetails.put(3, "1% Cash back on all eligible gas station, grocery store, drug " + "store purchases and recurring payments. \n" + "Interest rates: 19.99% purchases / \n" + "                22.99% cash advances");
    creditCardDetails.put(4, "4% groceries and recurring payments, 2% Cash back on all eligible " + "gas station, grocery store, drug store purchases and recurring payments. \n" + "Interest rates: 19.99% purchases / \n" + "                22.99% cash advances");
    creditCardDetails.put(5, "You will not pay 2.5% foreign transaction fees on any foreign currency" + " purchases, including online shopping and when travelling abroad \n" + "Interest rates: 19.99% purchases / \n" + "                22.99% cash advances");
  }
