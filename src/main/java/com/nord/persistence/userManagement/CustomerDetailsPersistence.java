...
public class CustomerDetailsPersistence extends AbstractUserDb implements ICustomerDetailsPersistence {
  ...
  public boolean addNewCustomer(Map<String, Object> customerDetails, boolean isAdmin) {
    ...
    try {
      ...
      String query = "INSERT INTO customer_details (firstname ,middlename, lastname, dateofbirth, email,mobile," + " streetno , city, state, pin_code, passportno, " + "isStudent, password, withdraw_limit, spending_limit,is_admin)" + " VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
